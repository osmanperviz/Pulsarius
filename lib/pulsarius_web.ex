defmodule PulsariusWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: PulsariusWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/pulsarius_web/templates",
        namespace: PulsariusWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {PulsariusWeb.LayoutView, :live},
